...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_ENT,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_ENT, \
                        KC_ESC,   KC_LSFT,  KC_BSPC,   RAISE,              LOWER,    KC_SPC,   KC_CAPS,  KC_RGUI   \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LALT,  KC_DEL,   KC_BSLS,  KC_SLSH,  KC_PIPE,  KC_DQUO,   KC_MPLY,  KC_0,    KC_1,    KC_2,    KC_3,    KC_LBRC, KC_RBRC, \
                        _______,  KC_ESC,  KC_LSFT,    KC_BSPC,            KC_SPC,   _______,    KC_RGUI,  KC_CAPS \
  ),
